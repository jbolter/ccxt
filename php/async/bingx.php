...
class bingx extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            if ($marketType === 'spot') {
                return Async\await($this->fetch_spot_markets($params));
            } elseif ($marketType === 'swap') {
                return Async\await($this->fetch_swap_markets($params));
            }
        }) ();
    }
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->$method ($marketTypeQuery));
            // spot
            //
            //  {
            //      "code" => 0,
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()) {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->swapV2PrivateGetUserPositions (array_merge($request, $params)));
            //
            // {
            //     "code" => 0,
            //         "msg" => "",
